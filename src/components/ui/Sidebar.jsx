...
function Sidebar() {
  ...
  return (
    <>
      ...
      <button
        className={`fixed top-6 z-50 p-3 bg-white text-slate-700 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-200 hover:border-indigo-300 ${
          isOpen ? 'left-72' : 'left-6'
        }`}
      ...
      {/* Sidebar */}
      <div 
        className={`fixed inset-y-0 left-0 z-40 transform transition-all duration-500 ease-in-out w-80 ${
      ...
      >
        <div className="h-full bg-gradient-to-br from-slate-50 via-white to-indigo-50/30 text-slate-800 p-8 flex flex-col shadow-2xl border-r border-slate-200 relative overflow-hidden">
          ...
          <div className="flex flex-col items-center mb-10 relative z-10">
            ...
            <p className="text-indigo-600 text-base font-medium mb-3">Software Engineer</p>
